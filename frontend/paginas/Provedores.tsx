...
import CardConexaoStripe from '../componentes/card.conexao.stripe';
import CardConexaoPaypal from '../componentes/card.conexao.paypal'; // Importe o novo componente
...
export const Provedores: React.FC = () => {
